...
import { BRAND_COLORS, SITE_CONFIG, WHY_EMAS } from "@/lib/config";
      ...
      <section className="py-12" style={{ backgroundColor: BRAND_COLORS.backgroundAlt }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-3 gap-8 text-center">
            <div>
              <p className="text-3xl font-bold" style={{ color: BRAND_COLORS.text }}>{featured.length + newArrivals.length + onSale.length || 0}+</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700" style={{ backgroundImage: "url('/brand/mujer-hero.jpg')", backgroundColor: BRAND_COLORS.backgroundAlt }} />
            ...
            >
              <div className="absolute inset-0 z-10" style={{ background: 'linear-gradient(135deg, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0.6) 100%)' }} />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent z-10" />
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700" style={{ backgroundImage: "url('/brand/hombre-hero.jpg')", backgroundColor: BRAND_COLORS.backgroundAlt }} />
              <div className="absolute bottom-0 left-0 right-0 p-8 z-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            {WHY_EMAS.map((item, i) => (
              ...
              >
                <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5" style={{ backgroundColor: 'rgba(0,0,0,0.06)' }}>
                  {item.icon === 'shield' && (
