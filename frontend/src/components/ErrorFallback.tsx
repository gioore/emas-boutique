  ...
  return (
    <div className={`flex items-center justify-center p-8 ${fullPage ? 'min-h-screen' : ''}`} style={{ backgroundColor: bgColor }}>
      <div className="text-center max-w-md">
        ...
        {onReset && (
          <button onClick={onReset} type="button" className="mt-4 px-4 py-2 text-sm font-medium rounded-lg transition-colors" style={{ backgroundColor: '#000000', color: '#ffffff' }}>
            Reintentar
          </button>
        )}
      </div>
