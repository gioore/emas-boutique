...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Productos de la boutique';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    availability: Schema.Attribute.Enumeration<
      ['available', 'low_stock', 'out_of_stock', 'pre_order']
    > &
      Schema.Attribute.DefaultTo<'available'>;
    brand: Schema.Attribute.Relation<'manyToOne', 'api::brand.brand'>;
    cat: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    category: Schema.Attribute.Enumeration<['mujer', 'hombre']> &
      Schema.Attribute.Required;
    ...
    slug: Schema.Attribute.UID<'name'>;
    subcat: Schema.Attribute.Relation<
      'manyToOne',
      'api::subcategory.subcategory'
    >;
    ...
    whatsapp: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'50255550000'>;
  };
}
